...
export default function Home() {
  ...
  const cardHoverStyle = {
    ...
    boxShadow:
      "0 26px 55px rgba(0,0,0,0.95), 0 0 0 1px rgba(0,255,184,0.25)",
      ...
      <div style={styles.page}>
        ...
        <div style={styles.hero}>
          ...
          <div style={styles.subtitle}>
            Join curated hiking, camping, rafting and city escape tours with real
            people — not fake profiles. Pick your activity, grab your backpack
            and meet outdoors.
          </div>

          <div style={styles.heroMetaRow}>
            <div style={styles.metaTag}>
              🏔️ <span>Verified guides</span>
            </div>
            <div style={styles.metaTag}>
              🤝 <span>Small friendly groups</span>
            </div>
            <div style={styles.metaTag}>
                ...
                >
                  ...
                  <div style={styles.cardBody}>
                    ...
                    <div style={styles.cardMetaRow}>
                      ...
                      <span>
                        👥 {t.max_people || t.capacity || "Small group"}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div style={styles.grid}>
              {events.map((e) => (
                <div
                  ...
                  onMouseLeave={(eDom) => {
                    eDom.currentTarget.style.transform =
                      "translateY(0px) scale(1)";
                    eDom.currentTarget.style.boxShadow =
                      "0 18px 40px rgba(0,0,0,0.85)";
                    eDom.currentTarget.style.borderColor =
                      "rgba(255,255,255,0.12)";
                  }}
                >
                  <div style={styles.cardMediaWrapper}>
